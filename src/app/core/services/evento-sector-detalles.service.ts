...
import { EventoSectorDetalleResponse, EventoSectorDetalleResponses } from '@core/interfaces/evento-sector-detalle.interface';
...
export class EventoSectorDetallesService {
  ...
  RegistrarEventoDetalleSector(eventoSectorDetalle: EventoSectorDetalleResponse) {
